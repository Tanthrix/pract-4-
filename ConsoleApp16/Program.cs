class Program
{
    static void Main(string[] args)
    {
        int position = 2;
        int when = 1;
        var Data = new List<String>() { "Выбрана дата 01.01.22", "Выбрана дата 02.02.22", "Выбрана дата 03.03.22", "Выбрана дата 04.04.22", "Выбрана дата 05.05.22" };
        var Dela = new List<String>() { "  1. Проверить работы", "  2. Сходить в магазин",
        ...
        var chivo = new List<String>() {"  Описание: Проверить работы по ААС", "  Описание: Сходить в продуктовый магазин за молоком",
